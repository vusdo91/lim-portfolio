...
export const ProfileProvider = ({ children }) => {
  ...
  const getDefaultProfile = () => ({
    ...
    exhibitions: [
      ...
      { id: 5, type: 'group', year: '2025', name: '느슨한 유역, 충북갤러리, 서울', name_en: 'Loose Basin, Chungbuk Gallery, Seoul' },
      { id: 6, type: 'group', year: '2025', name: '사건의 무대, 대전시립미술관, 대전', name_en: 'Stage Where It All Unfolded, Daejeon Museum of Art, Daejeon' },
      { id: 7, type: 'group', year: '2025', name: '인상화 - 작가의 시선, 에브리아트, 서울', name_en: 'Impressions - Artist\'s Perspective, Every Art, Seoul' },
      { id: 8, type: 'group', year: '2025', name: '느린 여름, 갤러리 아울, 후쿠오카', name_en: 'Slow Shower, Gallery Owl, Fukuoka' },
